...
class ReviewViewSet(viewsets.ModelViewSet):
    ...
    Частично обновить отзыв по id.Доступ:автор отзыва,модератор
    или администратор.
...
class CommentViewSet(viewsets.ModelViewSet):
    ...
    Создать новый комментарий для отзыва.Доступ:
    ...
    модератор или администратор. Удалить комментрий к отзыву по id.
    Доступ: автор отзыва, модератор или администратор.
    """
